...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" style=""> destinations </li>
        </ol>
    </nav>
@endsection
@section('content')
    <div class="container">
        <div class="main-content">
            ...
            <div class="form-container">
                <form action="{{route('destinations.update', $destination->id )}}" method="POST" enctype="multipart/form-data" id="destinationForm">
                    @csrf
                    @method('PUT')
                    <!-- Basic Information -->
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            <input type="checkbox" id="is_active" name="is_active" @checked(old('is_active' , $destination -> is_active)) >
